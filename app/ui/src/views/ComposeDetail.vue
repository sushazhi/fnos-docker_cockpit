    ...
    <template v-else>
      ...
      <div class="list-card">
        ...
        >
          ...
          <span class="badge" :class="getStatusClass(service.state)">
            {{ getStatusText(service.state) }}
          </span>
        </div>
      </div>
      ...
      <div class="tabs-container">
        <div class="tabs">
          ...
          <button class="tab" :class="{ active: tab === 'yaml' }" @click="tab = 'yaml'">
            YAML
          </button>
        </div>
      </div>
...
function getStatusText(state) {
  switch (state) {
    case 'running':
      return t('compose.state.running')
    case 'exited':
      return t('compose.state.exited')
    default:
      return state
  }
}
